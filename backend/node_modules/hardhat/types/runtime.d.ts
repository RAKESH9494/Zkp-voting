import { Artifacts } from "hardhat/src/types/artifacts";
import { HardhatConfig, HardhatUserConfig, NetworkConfig } from "hardhat/src/types/config";
import { EIP1193Provider, EthereumProvider } from "hardhat/src/types/provider";
/**
...
declare function addTask<TaskArgumentsT extends TaskArguments>(name: string, description?: string, action?: ActionType<TaskArgumentsT>): ConfigurableTaskDefinition;
declare function addTask<TaskArgumentsT extends TaskArguments>(name: string, action: ActionType<TaskArgumentsT>): ConfigurableTaskDefinition;
...
export interface RunSuperFunction<TaskArgumentsT extends TaskArguments> {
    (taskArguments?: TaskArgumentsT, subtaskArguments?: SubtaskArguments): Promise<any>;
    isDefined: boolean;
}
export type ActionType<TaskArgumentsT extends TaskArguments> = (taskArgs: TaskArgumentsT, env: HardhatRuntimeEnvironment, runSuper: RunSuperFunction<TaskArgumentsT>) => Promise<any>;
...
export type RunTaskFunction = (taskIdentifier: TaskIdentifier, taskArguments?: TaskArguments, subtaskArguments?: SubtaskArguments) => Promise<any>;
 ...
 */
export type ProviderExtender = (provider: EIP1193Provider, config: HardhatConfig, network: string) => EIP1193Provider | Promise<EIP1193Provider>;
export {};
